...
public static class L
{
    ...
    private static readonly Dictionary<string, (string pt, string en)> M = new()
    {
        ...
        ["cancelTransfer"] = ("CANCELAR TRANSFERÊNCIA", "CANCEL TRANSFER"),
        ["canceling"] = ("Cancelando…", "Canceling…"),
        ...
        ["queueColName"] = ("Nome", "Name"),
        ["queueColProgress"] = ("Progresso", "Progress"),
        ["queueColSize"] = ("Tamanho", "Size"),
        ["queueColTime"] = ("Hora", "Time"),
        ["queueDone"] = ("Concluído", "Done"),
        ["queueDoneVerified"] = ("Concluído ✓ verificado", "Done ✓ verified"),
        ["queueFailed"] = ("Falhou", "Failed"),
        ["queueFailedReason"] = ("Falhou: {0}", "Failed: {0}"),
        ["queueSkipped"] = ("Pulado", "Skipped"),
        ...
        ["deleteServer"] = ("Excluir servidor", "Delete server"),
        ["serverNamePrompt"] = ("Nome do servidor:", "Server name:"),
        ...
        ["ctxCreateFolder"] = ("Criar pasta", "Create folder"),
        ["ctxCopyPath"] = ("Copiar caminho", "Copy path"),
        ["ctxNewFolderPrompt"] = ("Nome da nova pasta:", "New folder name:"),
        ["ctxRenamePrompt"] = ("Novo nome:", "New name:"),
        ["ctxDeleteConfirm"] = ("Excluir \"{0}\"?", "Delete \"{0}\"?"),
        ["ctxOpFailed"] = ("Falha na operação: {0}", "Operation failed: {0}"),
        ["ctxPathCopied"] = ("Caminho copiado.", "Path copied."),
